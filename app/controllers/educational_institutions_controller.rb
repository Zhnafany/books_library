  ...
  def create
    ...
    respond_to do |format|
      if @educational_institution.save
        format.html { redirect_to(@educational_institution, :notice => 'EducationalInstitution was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @educational_institution.update_attributes(params[:educational_institution])
        format.html { redirect_to(@educational_institution, :notice => 'EducationalInstitution was successfully updated.') }
        format.xml  { head :ok }
      else
